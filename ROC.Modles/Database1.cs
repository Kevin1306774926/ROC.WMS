...
namespace ROC.Modles
{
    ...
    public class FakeRocContext : IRocContext
    {
        ...
        public FakeRocContext()
        {
            ...
            MenuClasses = new FakeDbSet<MenuClass>("Code");
        }
    ...
    public class MenuClassConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<MenuClass>
    {
        ...
        public MenuClassConfiguration(string schema)
        {
            ...
            Property(x => x.Code).HasColumnName(@"Code").IsRequired().HasColumnType("nvarchar").HasMaxLength(50).HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.Name).HasColumnName(@"Name").IsRequired().HasColumnType("nvarchar").HasMaxLength(50);
            Property(x => x.ParentCode).HasColumnName(@"ParentCode").IsOptional().HasColumnType("nvarchar").HasMaxLength(50);
            Property(x => x.Description).HasColumnName(@"Description").IsOptional().HasColumnType("nvarchar").HasMaxLength(50);
            Property(x => x.IsUsed).HasColumnName(@"IsUsed").IsRequired().HasColumnType("bit");
        }
    }
