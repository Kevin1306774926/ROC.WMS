...
{
    public partial interface IMenuClassService:IService<MenuClass>
    {
    ...
    /// 菜单服务类
    /// </summary>
    public partial class MenuClassService:AbstractService<MenuClass>,IMenuClassService
    {
        ...
        {
            var list = this.Get(null, "Menus").ToList<MenuClass>();
